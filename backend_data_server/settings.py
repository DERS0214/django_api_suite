...
SECRET_KEY = "django-insecure-7=m$gyr0b0ic-s$8x$7dar4x93j(jv9+w)naokbi(7t!(#g#d="

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['katesfv.pythonanywhere.com']
...
firebase_admin.initialize_app(FIREBASE_CREDENTIALS_PATH, {
   'databaseURL': 'https://casa-food-fa4d6-default-rtdb.firebaseio.com/'
})
